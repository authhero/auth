export const preSignupVerification = `
<!doctype html>
                          ...
                          <tbody>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:KHTeka, Helvetica, sans-serif;font-size:18px;font-weight:500;line-height:21.6px;text-align:left;color:#14141A;">{{registerPasswordAccount}}</div>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:KHTeka, Helvetica, sans-serif;font-size:16px;font-weight:400;line-height:19.2px;text-align:left;color:#88869F;">{{clickToSignUpDescription}}</div>
                              </td>
                            </tr>
                            <tr>
